...
#
# Loads shared resources (embedding model, Qdrant client, LLM) once at startup and stores in app_state.
# See app_state.py for details on this shared state management.
import logging
...
async def lifespan(app: FastAPI):
    ...
    app_state["llm"] = ChatGroq(model=settings.llm_model, temperature=0, groq_api_key=settings.groq_api_key)
